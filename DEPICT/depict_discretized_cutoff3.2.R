# 4-10-2017 MRC-Epid JHZ

library(openxlsx)
options(digits=3, scipen=20)
setwd("/genetics/data/gwas/4-7-17")
xlsx <- "depict_discretized_cutoff3.2.xlsx"
...
for(s in c("cells","multiplot","system", "tissues"))
{
  i <- paste0("DEPICT_",s)
  addWorksheet(wb, i)
  insertImage(wb, i, paste0("DEPICT2/tissue_plot_depict_genenetwork_",s,".png"), width=12, height=6)
}
